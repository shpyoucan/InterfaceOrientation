#
#  Be sure to run `pod spec lint InterfaceOrientationManager.podspec' to ensure this is a
...
Pod::Spec.new do |s|
s.name         = "HPInterfaceOrientationManager" # 项目名称
...
# User
s.author             = { "BY" => "shpyoucan@163.com" } # 作者信息
s.social_media_url   = "http://www.shpyoucan.top" # 个人主页
